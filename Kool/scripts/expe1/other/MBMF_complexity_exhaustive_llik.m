function  LL = MBMF_complexity_exhaustive_llik(x,subdata)

% parameters
b_low = x(1);           % softmax inverse temperature low
b_high0 = x(2);           % softmax inverse temperature high0
b_high1 = x(3);           % softmax inverse temperature high1
