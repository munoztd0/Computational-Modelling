...
var instructions_2_text = function(){
	...
	"<div align=justify>Let's practice flying to the planets! On each practice trial you will first see which planet you need to go from one of the following displays: <br><br><img style='margin:0px auto;display:block;height:200px' src='img/example_probes_planet.png'/><br><br>The planet, and therefore the display, will change from trial to trial. You will need to do this correctly <strong class='highlight'>15 times</strong> in a row before you can proceed. There will be a counter on screen to indicate how far along you are.</div>"];
	return instructions
};
...
var instructions_4_text = function(){
	...
	"<div align=justify>In the real experiment, you will get 10 seconds for choice. Our advice is to think carefully about your strategy, but also to trust your instincts. By concentrating you can increase the number of points you win by a lot. There is an element of chance, but a lot of room for skill as well.<br><br>Now, you will do 25 practice trials. These don't count towards your total bonus amount and there will be no time limit to help you learn.</div>"];
	return instructions
};

var instructions_5_text = function(){
	var instructions = ["<div align=justify>Great job! There's one more thing you need to learn before you can start the real experiment.<br><br>From now on, at the start of the trial, the aliens will SOMETIMES dig up a DIAMOND from their space mine:<br><br><img style='margin:0px auto;display:block;height:68px' src='img/diamond.png'/><br>This will happen rarely, and if it happens there will be only ONE alien who finds a diamond.<br><br>Diamonds are worth a lot! If you find the alien with the diamond, you will earn <strong  class='highlight'>200 points</strong>.</div>",
	"<div align=justify>Because diamonds are worth a lot, the space mining company wants you to pick them up as soon as they are found, and not go the other aliens. So, they will give you a big reward if you get the diamond, but zero points otherwise.<br><br>On trials where a diamond was found, you will first see a display that tells you that this has happened AND which alien has the diamond. Here is an example:<br><br><img style='margin:0px auto;display:block;height:150px' src='img/probe_red.png'/><br>In this case, the red alien has found a diamond.<br><br>If you would then go to the red alien on that trial, you would earn 200 points. This is more than 20 times the maximal point value for a regular trial! However, you would earn <strong class='highlight'>zero points</strong> when you would visit the other aliens, which would be on the yellow and purple planet in this example.</div>",
	"<div align=justify>It's important to know that on each trial you can visit any planet, so you will always be able to go to the alien with the diamond.<br><br>Furthermore, diamonds occur in a random fashion. This means that you cannot predict when and where they will be found.<br><br>On trials after a diamond has been found, the aliens will give you treasure from their own mines again. The trials with a diamond do not change how good each of their mines are!<br><br>As you can see, finding the diamonds is a very efficient way to increase your score!</div>",
	"<div align=justify>OK, you are now ready for the real game. You will find new aliens with new mines on the three planets, but everything else will be the same.<br><br>Let's review everything we've learned and then begin playing.<br><br>Remember, you want to find as much space treasure as you can by flying to planets and asking an alien to mine for you. How much treasure comes out of each alien's mine changes slowly over time, so you need to concentrate and be flexible to keep track of which spacestations, spaceships and aliens are good right now.<br><br>If a diamond is found, you will be told at the start of the trial which alien has it. On those trials, you can earn a lot of points when you get the diamond (200 points), but there will be no points for visiting the other two aliens on that trial (0 points).</div>",
	"<div align=justify>You will get a bonus payment of 1 dollar cent for every 10 points you earn and 200  points for every diamond.<br><br>The game lasts for 200 trials, and you will get 10 seconds for each choice. This will take approximately 30 minutes.<br><br>You will be given the opportunity for a break in the middle of the HIT.<br><br>The HIT will start after you press 'next', make sure you have your fingers on the 'F', 'G', and 'H' keys! Good luck!</div>"];
	return instructions
}
